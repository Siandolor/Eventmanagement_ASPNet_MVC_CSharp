...
public class AdminController : Controller
{
    ...
    public AdminController(EventmanagementContext context, IWebHostEnvironment env)
    {
        _context = context;
        _env = env;
    }
    ...
    [HttpGet]
    public IActionResult CreateUserAdmin(string model)
    {
        return View("CreateUserAdmin", new UserRegistrationAndRoles
        {
            SelectedRole = model,
    ...
    public IActionResult RegisterCustomer(UserRegistrationAndRoles model)
    {
        ...
        if (model.Customer?.Customer_LogIn == null)
        {
            ...
            return View("CreateUserAdmin", model);
        }
    ...
    public async Task<IActionResult> UserIndexAdmin(string userType)
    {
    ...
    public async Task<IActionResult> UserDetailsAdmin(string userType, Guid id)
    {
    ...
    public async Task<IActionResult> UpdateUserAdress(Guid id, string streetName, string streetNumber, string apartmentNumber, string zip, string city, string state, string country)
    {
        ...
        return RedirectToAction("UserDetailsAdmin", new { userType, id });
    }
    ...
    [HttpPost]
    public async Task<IActionResult> UpdateUserEntry(Guid id, DateTime entry)
    {
        var login = await _context.LogIns
            .Include(l => l.InternalCoworker)
            .FirstOrDefaultAsync(l => l.LogIn_Id == id);
        ...
        if (login?.InternalCoworker != null)
        {
            login.InternalCoworker.InternalCoworker_EntryDate = entry;
            await _context.SaveChangesAsync();
        }
    ...
    [HttpPost]
    public async Task<IActionResult> UpdateUserExit(Guid id, DateTime exit)
    {
        var login = await _context.LogIns
            .Include(l => l.InternalCoworker)
            .FirstOrDefaultAsync(l => l.LogIn_Id == id);
        ...
        if (login?.InternalCoworker != null)
        {
            login.InternalCoworker.InternalCoworker_ExitDate = exit;
            await _context.SaveChangesAsync();
        }
    ...
    public async Task<IActionResult> TogglePublish(Guid id)
    {
        ...
        return RedirectToAction(nameof(UserDetailsAdmin), new { userType = "Organizer", id = loginId });
    }
    ...
    public async Task<IActionResult> OrganizerEvents()
    {
        ...
        return PartialView("~/Views/Admin/_OrganizerEvents.cshtml", events);
    }
    ...
    public async Task<IActionResult> DeleteEvent(Guid id)
    {
        ...
        return RedirectToAction("UserDetailsAdmin", new { userType = "Organizer", id = loginId });
    }
    ...
    public async Task<IActionResult> ToggleBlock(string userType, Guid id)
    {
        ...
        return RedirectToAction(nameof(UserIndexAdmin), new { userType });
    }
